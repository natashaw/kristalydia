...
class Contact extends Component {
    ...
    handleSubmit = (event) => {
        ...
        }).then(() => alert("Inquiry submitted. Thank you!")).catch(error => alert(error));
    };
    ...
    render() {
        ...
        return (<Container>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 405.9 62" enable-background="new 0 0 405.9 62" style={{
                    position: 'relative',
                    width: '40vh'
                }}>
                <g>
            ...
            <br/><br/>
            <Form name="contact" data-netlify="true" method="POST" data-netlify-honeypot="bot-field" onSubmit={this.handleSubmit}>
                <input type="hidden" name="form-name" value="contact"/>
                <Form.Group>
                    <Form.Label>Your Name< /Form.Label>
                        <Form.Control type="text" name="name" placeholder="First Name Last Name" required="required" isInvalid={errors.name} onChange={this.handleChange}/>
