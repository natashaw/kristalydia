...
export class SidebarMobile extends Component {
    constructor(props) {
        ...
        return(
            <div id="SiteWrapper">
                <div id="MenuBulge" >
                    ...
                    <svg width="100vw" height="auto" style={{ transform: `rotateX(180deg)` }}>
                        <path className="overlay" style={{ transform: `scale(2)`}} d="M 0 0 C 0 50 0 100 0 150 C 0 300 0 400 0 500 C 0 600 0 700 0 800 C 0 900 0 950 0 1000 L 0 1000 L 0 0 Z"></path>
                    </svg>
                    <Tween from={{
                            opacity: 0,
                            y: -32
                        ...
                        <div id="burgers" className="sbtn" style={{ display: 'block' }}
                            >
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 83.5 80.8" style={{ transform: `matrix(1, 0, 0, 1, 20, 40)`, display: 'block' }} enable-background="new 0 0 83.5 80.8">
                                    <g id="Layer_1">
                                        <g>
                                            <g>
                            ...
                            <div className="hitarea" onClick={this._clickBarOpen} style={{ height: '4vh', width: '4vh', transform: `matrix(1, 0, 0, 1, 20, 40)`, display: 'block'}}/>
                        </div>
                    </div>
                    </Tween>
